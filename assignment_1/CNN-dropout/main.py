...
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.title('Training & Test Losses With Dropout Layer')
plt.legend()
plt.show()
plt.savefig("Training & Test Losses With Dropout Layer")
...
plt.title('Training & Test Accuracies With Dropout Layer')
plt.legend()
plt.show()
plt.savefig("Training & Test Accuracies With Dropout Layer")