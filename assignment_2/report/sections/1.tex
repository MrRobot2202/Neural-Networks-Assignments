...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.8\textwidth]{images/ex_1/ex1_autoencoder_loss_l2} 
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.95\textwidth]{images/ex_1/ex1_reconstructions_l1} 
    \caption{Reconstructions for L1}
\end{figure}

\begin{figure}[H] 
    \centering
    \includegraphics[width=0.95\textwidth]{images/ex_1/ex1_reconstructions_l2} 
...
\textbf{Encoder}
\lstinputlisting{scripts/ex_1/Encoder.py}

\textbf{Decoder}
\lstinputlisting{scripts/ex_1/Decoder.py}

\textbf{Autoencoder}
\lstinputlisting{scripts/ex_1/Autoencoder.py}

\textbf{Train Autoencoder}
\lstinputlisting{scripts/ex_1/train_autoencoder.py}
...
\lstinputlisting{scripts/ex_1/DownstreamClassifier.py}

\textbf{Train Downstream}
\lstinputlisting{scripts/ex_1/train_downstream.py}
